(window.webpackJsonp = window.webpackJsonp || []).push([
  ['chart-widget-gui'],
  {
    ...
    '1ANp': function (t, e, i) {
      'use strict';
      function s (t) {
        return t === 'alwaysOn' || t === 'alwaysOff' ? t : 'visibleOnMouseOver';
      }
      function n () {
        if (!u) {
          (u = new h.a()).setValue(
                    ...
                    ((u && t.enabled('fundamental_widget')) ||
                      (!s.showLegend && u && c
                        ...
                        : (u || s.showStudyTitles || s.showStudyValues) &&
                          s.showLegend &&
                          ((p = $('<div>').addClass(
                            'pane-legend-line pane-legend-wrap myline'
                          )),
                          this._options.sourceSelectionEnabled ||
                            p.addClass('legend-selection-disabled'),
                          p.appendTo(this.$el),
          ...
          (o.prototype._generateItemsForRow = function (e, s, n) {
            ...
            if (
              (((y && n.showSeriesTitle) || (!y && n.showStudyTitles)) &&
                ((r = $('<span>')).addClass(
                  'pane-legend-line__wrap-description apply-overflow-tooltip myhide'
                ),
                ...
                !this._chart.readOnly() &&
                  ...
                  (y && w) ||
                    ...
                    $(
                      ...
                      .on(
                        'click touchend',
                        this._generateItemsForRow._onShowhideClick.bind(this, g)
                      ),
                  !y &&
 ...
 (p = $("<span class='pane-legend-item-value-wrap pane-legend-item-value-wrap-13'>").appendTo(
                  u
                )),
                  (_ = y
                ...
                Array.isArray(i.cell) ||
                  ...
                  (l =
                    ...
                    this._model.selection().isSelected(o)
                      ? 'bold'
                      : 'normal'),
                  typeof i.value.getSplitTitle == 'function'
                  ...
                  i.isCellInited ||
                    ...
                    d || h
                      ? ((i.titleElement = document.createElement('div')),
                        ...
                        i.descriptionElement.classList.add(
                          'pane-legend-title__description1'
                        ),
                      ...
                      : ((i.titleElement = document.createElement('div')),
                        ...
                        (i.descriptionElement = document.createElement('div')),
                        i.descriptionElement.classList.add(
                          'pane-legend-title__description2'
                        ),
                        i.titleElement.appendChild(i.descriptionElement))),
 ...
 for (t = 0, e = this._btnGroups; t < e.length; t++) { e[t].classList.add('js-hidden'); }
}
              (this._buttons = {
                ...
                this._chart.withModel(this, function () {
                  (i._chartModel = i._chart.model()),
                    ...
                    i._chartBackgroundProperty !== null &&
 ...
 (i = e[t]),
              ...
              this._buttons.turn.addEventListener('click', function (t) {
                ...
                this._buttons.zoomOut.addEventListener('click', function (t) {
                  t.preventDefault(),
                    s._chartModel !== null && s._chartModel.zoomOut(),
                    s._trackEvent('Zoom Out');
                }),
                this._buttons.zoomIn.addEventListener('click', function (t) {
                  t.preventDefault(),
                    s._chartModel !== null && s._chartModel.zoomIn(),
            ...
            (t.prototype._check = function () {
              if (this._chartModel !== null && this._back !== null) {
            ...
            (t.prototype._onVisibilityTypeChange = function () {
              if (this._visibilityTypeProperty !== null) {
                var t = this._visibilityTypeProperty.value();
                t === 'alwaysOn' || t === 'alwaysOff'
                  ? ((this._controlBarVisible = t === 'alwaysOn'),
                    this._boundMouseHandler !== null &&
                      (this._parent.removeEventListener(
                        'mousemove',
                        this._boundMouseHandler,
            ...
            (t.prototype._visibilityMouseHandler = function (t) {
              ...
              t.buttons ||
                ...
                ((e = !1),
                (t.type !== 'mousemove' && t.type !== 'mouseleave') ||
                  this._widget === null ||
 ...
 return this._btnGroups.find(function (e) {
            ...
            (t.prototype._stopMoveByBar = function () {
              this._state === 'moving' &&
                ...
                (this._movingTimeout = 0),
                (this._currentDistance = 0),
                this._chartModel !== null && this._chartModel.endUndoMacro());
            }),
 ...
 if (this._visible && this._chart.isActive()) {
              if (
                ...
                this.jqDiv.toggleClass(
                  'toppane',
                  e === 0 || this._chart.isMaximizedPane()
                ),
                (n = !1),
 ...
 if (r[l] instanceof TradingView.Study && ++o > 1) {
        ...
        (s.prototype._visibilityMouseHandler = function (t) {
          (this._visible = t.type === 'mouseenter'), this.update();
        }),
        (t.exports = s);
    },
    qfuz: function (t, e) {

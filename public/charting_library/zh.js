let s = {
  ...
  W_interval_short: 'W',
  M_interval_short: 'M',
  'Remove from favorites': '从常用中移除',
  'Add to favorites': '添加到常用',
  ...
  'Specified value is less that the instrument minimum.':
    '指定值低于最低限度。',
  'Specified value is more than the instrument maximum.':
    '指定值大于最大限度。',
  Risk: '风险',
  Connecting: '正在连接',
  Delayed: '延时',
  ...
  'Arnaud Legoux Moving Average_study':
  ...
  'Detrended Price Oscillator_study':
    '非趋势价格摆动指标(Detrended Price Oscilla333tor)',
  ...
  'Least Squares Moving Average_study':
  ...
  'Moving Average Exponential_study':
  ...
  'SMI Ergodic Indicator/Oscillator_study':
  ...
  'Value Area Volume_input': '价格区成交量',
  Placement_input: '配置',
  POC_input: 'POC',
  'Developing Poc_input': '发展Poc',
  'Up Volume_input': '上涨成交量',
  'Down Volume_input': '下跌成交量',
  'Value Area_input': '价值区',
  'Histogram Box_input': '直方图框(Histogram Box)',
  'Value Area Up_input': '高值区域',
  'Value Area Down_input': '低值区域',
  ...
  "Sorry, the Copy Link button doesn't work in your browser. Please select the link and copy it manually.":
    '抱歉，复制链接的按钮在浏览器中无法使用。 请选择链接并手动复制。',
  minutes_interval: '分钟',
  hours_interval: '小时',
  days_interval: '日',
  weeks_interval: '周',
  ...
  'Toggle Percentage Scale': '切换比例规模',
  ...
  'Show Favorite Drawings Toolbar': '显示常用的绘图工具栏',
  Icon: '图标',
  Icons: '图标',
  ...
  'Show Line': '显示线',
  'Show Label on Price Scale': '显示价格标签',
  'Last Price And Percentage Value': '最后价格和百分比值',
  'Last Value According To Scale': '根据坐标的最后值',
  'Auto (Fits Data to Screen)': '自动(调整数据以适应屏幕)',
  Lock: '锁定',
  ...
  'OHLC Values': '开高低收',
  'Show Chart Source Value Only': '只显示图表来源数据',
  ...
  'Lock Price To Bar Ratio': '锁定价格与K线比例',
  Undo: '撤销',
  Redo: '重做',
  'Change Symbol...': '变更品种...',
  'Any Symbol': '任一品种',
  ...
  'Symbol Last Value Label': '最新价格标签',
  ...
  'Show Legend of Indicators': '显示指标图例',
  'Hide Legend of Indicators': '隐藏指标图例',
  'Show/Hide': '显示/隐藏',
  ...
  'Pinned To Scale {label} (Hidden)': '固定比例{label} （隐藏）',
  'Pinned To Right Scale (Hidden)': '固定比例到右侧（隐藏）',
  'Pin To Scale {label} (Hidden)': '固定坐标{label}（隐藏）',
  'Pin To Right Scale (Hidden)': '固定至右坐标（隐藏）',
  'Pinned To Scale {label}': '已固定坐标{label} ',
  'Pinned To Right Scale': '已固定至右坐标',
  'Pin To Scale {label}': '固定坐标{label} ',
  ...
  'Pin To Left Scale': '固定坐标至左侧',
  'Pin To New Left Scale': '固定至左侧新坐标',
  'Pin To New Right Scale': '固定至右侧新坐标',
  'Pin To Scale (Now {label})': '固定至坐标（目前{label} ）',
  'Pin To Scale (Now No Scale)': '固定至坐标（目前无坐标）',
  'Pin To Scale (Now Left)': '固定坐标（目前左侧）',
  'Pin To Scale (Now Right)': '固定坐标（目前右侧）',
  'Paste %s': '粘贴%s',
  'Time Scale': '时间坐标',
  'No Scale (Fullscreen)': '没有尺度(全屏)',
  ...
  'Add Indicator on {0}...': '在{0}增加指标...',
  'Move To': '移动到',
  'Click to set a point': '点击以设定',
  '1. Slide your finger to select location for first anchor{new_line}2. Tap anywhere to place the first anchor':
    '1.请拖曳您的手指选择第一个游标的放置地点{new_line}2.点击任何一处即可定位',
  '1. Slide your finger to select location for next anchor{new_line}2. Tap anywhere to place the next anchor':
    '1.请拖曳您的手指选择下一个游标的放置地点{new_line}2.点击任何一处即可定位',
  ...
  'Projection Up Color': '阳线颜色',
  'Projection Down Color': '阴线颜色',
  Fill: '填充',
  'Up Color': '上涨颜色',
  'Down Color': '下跌颜色',
  Traditional: '传统',
  ...
  'Quandl is a huge financial database that we have connected to TradingView. Most of its data is EOD and is not updated in real-time, however the information may be extremely useful for fundamental analysis.':
    'Quandl是一个巨大的金融数据资料库，我们已经将它连接到TradingView。它的大部分数据是EOD，非即时更新的，然而，这些资讯可能对基本面分析是非常有用的。',
  ...
  'Move {title} To New Price Scale': '将{title}移至新价格比例',
  'Move {title} To New Left Scale': '将{title}移动到新的左侧价格比例',
  'Make {title} No Scale (Full Screen)': '使{title} 无价格比例（全屏）',
  '{0} bars': '{0}根K线',
  Jan: '1月',
  Feb: '2月',
  Mar: '3月',
  ...
  hour: '小时',
  range: '范围',
  'Stack On The Left': '堆叠在左边',
  'Stack On The Right': '堆叠在右边',
  Auto: '自动',
  'not authorized': '未经授权',
  ...
  'Invite-only script. Contact the author for more information.':
    '仅限邀请的脚本。请联系作者了解更多详情。',
  'Invite-only script. You have been granted access.':
    '仅限邀请的脚本。您已被授予访问权限。',
  like: '个赞',
  'Symbol Name': '商品名称',
  ...
  Fr_day_of_week: '星期五',
  Sa_day_of_week: '周六',
  '{specialSymbolOpen}Today at{specialSymbolClose} {dayTime}':
    '{specialSymbolOpen}今天在{specialSymbolClose}{dayTime}',
  '{specialSymbolOpen}Tomorrow at{specialSymbolClose} {dayTime}':
    '{specialSymbolOpen}明天在{specialSymbolClose}{dayTime}',
  '{dayName} {specialSymbolOpen}at{specialSymbolClose} {dayTime}':
    '{dayName}{specialSymbolOpen}在{specialSymbolClose}{dayTime}',
  '{specialSymbolOpen}Yesterday at{specialSymbolClose} {dayTime}':
    '{specialSymbolOpen}昨天在{specialSymbolClose}{dayTime}',
  '{specialSymbolOpen}Last{specialSymbolClose} {dayName} {specialSymbolOpen}at{specialSymbolClose} {dayTime}':
    '{specialSymbolOpen}上个月{specialSymbolClose} {dayName} {specialSymbolOpen}在{specialSymbolClose} {dayTime}',
  'just now': '刚刚',
  'in %s_time_range': '在%s',

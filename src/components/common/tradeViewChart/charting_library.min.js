/* eslint-disable */
!(function(t, e) {
  typeof exports == 'object' && typeof module != 'undefined' ? e(exports) : typeof define == 'function' && define.amd ? define(['exports'], e) : e(t.TradingView = {})
}(this, function(t) {
  'use strict';
  ...
  function o(t, i) {
    var n = e({}, t);
    for (var s in i)
      typeof t[s] != 'object' || t[s] === null || Array.isArray(t[s]) ? void 0 !== i[s] && (n[s] = i[s]) : n[s] = o(t[s], i[s]);
    return n
  }
  var i = {
    mobile: {
  ...
  function s() {
    return '1.15 (internal id 37fbf462 @ 2020-04-24 15:44:13.516973)'
  }
  var r = (function() {
    function t(t) {
      ...
      this._options.theme === 'Dark' && void 0 === this._options.loading_screen && (this._options.loading_screen = {
    ...
    return t.prototype.onChartReady = function(t) {
      ...
      t.prototype._create = function() {
        ...
        var i = this._iFrame;
        (this._options.autosize || this._options.fullscreen) && (i.style.width = '100%',
      ...
      t.prototype._render = function() {
        ...
        return '<iframe id="' + this._id + '" name="' + this._id + '"  src="' + e + '"' + (this._options.autosize || this._options.fullscreen ? '' : ' width="' + this._options.width + '" height="' + this._options.height + '"') + ' frameborder="0" allowTransparency="true" scrolling="no" allowfullscreen style="display:block;height:100%"></iframe>'
      }
      ,
      t
  }());
